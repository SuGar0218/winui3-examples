            ...
            Style = new Style {
                ...
                Setters = {
                    new Setter {
                        ...
                        //Value = Application.Current.Resources["SystemControlAcrylicElementBrush"]
                        //Value = new SolidColorBrush(Color.FromArgb(127, 255, 255, 255))
                        //Value = new SolidColorBrush(Color.FromArgb(127, 0, 0, 0))
                    }
                }
            }
        };
